 ...
 *                          format.
 *   image_url (string)   - The file name in the image directory of the picture.
...
const im = {
  ...
  login_name: "ianmalcolm1",
  password: "ianmalcolm1",
};
const er = {
  ...
  login_name: "ellenripley2",
  password: "ellenripley2",
};
const pt = {
  ...
  occupation: "Thain",
  login_name: "peregrintook3",
  password: "peregrintook3",
};
const rk = {
...
const al = {
  ...
  login_name: "aprilludgate5",
  password: "aprilludgate5",
};
const jo = {
  ...
  login_name: "johnousterhout6",
  password: "johnousterhout6",
};
